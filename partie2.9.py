#un programme  qui permet le suivi de l’occupation de tous les parkings de Montpellier en
#permettant à l’utilisateur de choisir la période d’échantillonnage Te et la durée de l’acquisition. Il
#pourra également indiquer le nom du fichier dans lequel seront enregistrées les données. 
